...
pub type ExifTagRecordSimple {
  ExifTagRecordSimple(
    ...
    sub_sec_time_original: Option(Int),
    sub_sec_time_digitized: Option(Int),
...
pub fn to_simple(from_library: ExifTagRecord) -> ExifTagRecordSimple {
  ExifTagRecordSimple(
    ...
    subject_area: from_library.subject_area,
    sub_sec_time_original: from_library.sub_sec_time_original,
    sub_sec_time_digitized: from_library.sub_sec_time_digitized,
    flash_pix_version: from_library.flash_pix_version,
    color_space: from_library.color_space,
    exif_image_width: from_library.exif_image_width,
    exif_image_height: from_library.exif_image_height,
    sensing_method: from_library.sensing_method,
    scene_type: from_library.scene_type,
    exposure_mode: from_library.exposure_mode,
    white_balance: from_library.white_balance,
    focal_length_in_35_mm_format: from_library.focal_length_in_35_mm_format,
    scene_capture_type: from_library.scene_capture_type,
    lens_make: from_library.lens_make,
    lens_model: from_library.lens_model,
    composite_image: from_library.composite_image,
    gps_latitude_ref: from_library.gps_latitude_ref,
  )
}
